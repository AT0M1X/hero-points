...
- The manager keeps a Foundry-native surface treatment with gold accents for persistent/primary actions and blue accents for session/active-roster states; preserve that visual language when extending its UI.
